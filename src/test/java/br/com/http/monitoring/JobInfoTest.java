...
public class JobInfoTest {
	...
	public void testIsHealthy() throws Exception {
		...
		historyJob1.add(new JobExecutionInfo(1l, now, now, 200, "Success"));
		...
		historyJob2.add(new JobExecutionInfo(2l, now, now, 500, "Success"));
		...
		historyJob3.add(new JobExecutionInfo(3l, now, now, 200, "Failed"));
		...
		historyJob4.add(new JobExecutionInfo(4l, late, late, 200, "Success"));
	...
	public void testExecutionIsLate() throws ParseException {
		...
		final Date late = new SimpleDateFormat("dd/MM/yyyy").parse("01/01/2014");
		historyJob2.add(new JobExecutionInfo(1l, late, late, 200, "Success"));
